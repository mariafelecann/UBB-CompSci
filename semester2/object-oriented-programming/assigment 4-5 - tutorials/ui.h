...
public:
	...
	void add_tutorial_to_watch_list(const Service& service, const Service& service_watch_list);
	int see_next_tutorial(const Service& service, const Service& service_watch_list, const std::string name, const int& last_time);
	void delete_tutorial_from_watch_list(const Service& service, const Service& service_watch_list);
