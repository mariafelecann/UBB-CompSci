...
class SevenNineBoard(Frame):
    def __init__(self, parent, controller, ai):
        ...
        self.Button_eight2 = Button(self, activebackground="#d9d9d9", activeforeground="#341a87", background="#e1ccd5",
        ...
        self.Button_fourteen2 = Button(self, activebackground="#d9d9d9", activeforeground="#341a87",
                                      background="#e1ccd5",
                                      disabledforeground="#ffe5e5", foreground="#341a87", highlightcolor="black",
                                      relief=SUNKEN,
                                      height=2, width=5, pady="0", padx="0",
        ...
        self.Button_twenty2 = Button(self, activebackground="#d9d9d9", activeforeground="#341a87", background="#e1ccd5",
                                    disabledforeground="#ffe5e5", foreground="#341a87", highlightcolor="black",
                                    relief=SUNKEN,
                                    height=2, width=5, pady="0", padx="0",
        ...
        self.Button_twentysix2 = Button(self, activebackground="#d9d9d9", activeforeground="#341a87",
                                       background="#e1ccd5",
                                       disabledforeground="#ffe5e5", foreground="#341a87", highlightcolor="black",
                                       relief=SUNKEN,
                                       height=2, width=5, pady="0", padx="0",
        ...
        self.Button_thirytwo2 = Button(self, activebackground="#d9d9d9", activeforeground="#341a87",
                                      background="#e1ccd5",
                                      disabledforeground="#ffe5e5", foreground="#341a87", highlightcolor="black",
                                      relief=SUNKEN,
                                      height=2, width=5, pady="0", padx="0",
        ...
        self.Button_thirtyeight2 = Button(self, activebackground="#d9d9d9", activeforeground="#341a87",
                                         background="#e1ccd5",
                                         disabledforeground="#ffe5e5", foreground="#341a87", highlightcolor="black",
                                         relief=SUNKEN,
                                         height=2, width=5, pady="0", padx="0",
        ...
        self.Button462 = Button(self, activebackground="#d9d9d9", activeforeground="#341a87",
                               background="#e1ccd5",
                               disabledforeground="#ffe5e5", foreground="#341a87", highlightcolor="black",
                               relief=SUNKEN,
                               height=2, width=5, pady="0", padx="0",
        ...
        try:
            if self.in_turn == 1:
                ...
                if self.__ai.game_over() is False:
                    messagebox.showinfo("Congratulations!", "You are a winner!.. This time")
                    return
                self.in_turn = 2
            ...
            if self.in_turn == 2:
                ...
                self.in_turn = 1
                if self.__ai.game_over() is False:
                    messagebox.showinfo("Better luck next time...", "Computer has won! :P")
                    return
